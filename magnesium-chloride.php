...
<body>
    ...
    <section class="hero-image">
        <picture>
            <!-- Mobile Image -->
            <source media="(max-width: 767px)" srcset="img/magnesium-chloride-small.png ">

            <!-- Desktop Image -->
            <img src="img/magnesium-chloride-banner.jpg" alt="Magnesium Chloride Flakes and Powder">
        </picture>
    </section>
