...
<body>
    ...
    <section class="hero-image">
        <picture>
            <!-- Mobile Image -->
            <source media="(max-width: 767px)" srcset="img/magnesium-sulphate-small.png">

            <!-- Desktop Image -->
            <img src="img/magnesium-sulphate-banner.jpg" alt="Magnesium Sulphate Epsom Salt">
        </picture>
    </section>
                ...
                <div class="col-lg-8">
                    <div class="content-box">
                        ...
                        <h1 class="fw-bold mb-3">
                            Magnesium Sulphate – MgSO<sub>4</sub>
                        </h1>
